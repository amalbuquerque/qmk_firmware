...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Ctrl  |  A|  S|  D|  F|  G|  H|  J|  K|  L|;F5|  '|Entr/Fn4|
     * |-----------------------------------------------------------|
    ...
    [0] = KEYMAP( \
        ...
        LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   FN5 ,QUOT,     FN4 ,      \
     ...
     * |-----------------------------------------------------------|
     * |Ctrl  |F17|F18|F19|F20|   |Lef|Dow| Up|Rig| Bs|   |  Fn4   |
     * |-----------------------------------------------------------|
     ...
     */
    [1] = KEYMAP( \
        PWR , F1 ,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10,   F11 ,F12, FN6 , TAB, \
        CAPS,F13 , F14, F15, F16,  NO,  NO,HOME,END , NO ,PAUS,   NO  ,NO , DEL ,      \
        TRNS,F17 , F18, F19, F20,  NO,LEFT,DOWN,  UP,RGHT,   BSPC,NO  ,     FN4 ,      \
    ...
    [2] = KEYMAP( \
        ...
        TRNS,VOLD,MPRV,MNXT, NO ,  NO,NO  ,NO  , NO ,NO  ,   NO  ,NO  ,     FN4 ,      \
